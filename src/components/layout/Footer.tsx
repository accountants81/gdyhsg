    ...
    <footer className="border-t border-border/40 bg-background/95">
      <div className="container py-8 max-w-screen-2xl">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div> 
            <h3 className="text-lg font-semibold mb-3 md:text-end">تواصل معنا</h3>
            <div className="flex space-x-4 rtl:space-x-reverse mb-4 md:justify-end">
            ...
            <p className="text-sm text-muted-foreground md:text-end">البريد الإلكتروني: <a href="mailto:info@aaamo.com" className="hover:text-foreground">info@aaamo.com</a></p>
            <p className="text-sm text-muted-foreground md:text-end">رقم الهاتف: <a href="tel:+201234567890" className="hover:text-foreground" dir="ltr">+20 123 456 7890</a></p>
          </div>
        </div>
